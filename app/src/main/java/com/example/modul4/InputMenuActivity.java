        ...
        ref.putFile(imageUri)
                        ...
                        firebaseFirestore.collection("menu").add(inputMenu)
                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                    ...
                                    public void onSuccess(DocumentReference documentReference) {
                                        Toast.makeText(InputMenuActivity.this, "Uploaded", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(InputMenuActivity.this, MainActivity.class);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        Toast.makeText(InputMenuActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    protected void onActivityResult(int reqCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            try {
                ...
                e.printStackTrace();
                Toast.makeText(InputMenuActivity.this, "failed", Toast.LENGTH_LONG).show();
            }

        }else {
            Toast.makeText(InputMenuActivity.this, "Pilih gambar dulu",Toast.LENGTH_LONG).show();
        }
    }
